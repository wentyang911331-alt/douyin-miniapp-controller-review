...
当前阶段已完成 1.1.5 标题 / logo 与 loading 版本。

当前版本为 1.1.5，开发分支为 `codex/v1.1.5-title-logo`。代码基线为 `v1.1.4`。`v1.1.5` 已准备提交、打标签并推送 GitHub 备份。
...
1. 1.1.5 已截止，后续新需求按 1.1.6 或后续版本重新整理口径。
